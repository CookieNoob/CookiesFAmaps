...

{
    ...
    values = {
        ...
        { text = "disabled - 4v4 mex", help = "Map will not adjust for players and will spawn the mexes of the first eight players and their expansions. Use the spots 1-8", key = 2, },
...

{
    ...
    pref = 'plateaumex',
    values = {
        { text = "enabled - more mex", help = "Spawn additional mexes on all plateaus.", key = 1, },
        { text = "enabled", help = "Spawn additional mexes on a few plateaus.", key = 2, },
        { text = "disabled", help = "Spawn no additional mexes on the plateaus.", key = 3, },
    },
},

{
    ...
    pref = 'islandmex',
    values = {
        { text = "enabled - more mex", help = "Spawn most mexes on the islands.", key = 1, },
        { text = "enabled", help = "Spawn mexes on half of the islands.", key = 2, },
        { text = "disabled", help = "Spawn no mex on the islands.", key = 3, },
    },
},

{
    ...
    help = "configure the amount of mexes underwater in the central area of the map.",
    key = 'underwatermex',
    pref = 'underwatermex',
    values = {
        { text = "enabled - more mex", help = "Spawn additional mexes in the water around the islands.", key = 1, },
        { text = "enabled", help = "Spawn some additional mexes in the water around the islands.", key = 2, },
        { text = "disabled", help = "Spawn no additional mexes in the water around the islands.", key = 3, },
    },
},

{
    ...
    values = {
        ...
        { text = "much more reclaim", help = "Add some frigates and destroyers to the map.", key = 4, },
    },
},
{
    default = 2,
    label = "Civilian Base",
    help = "Spawn a civilian base on the side plateaus.",
    key = 'optional_civilian_base',
    pref = 'optional_civilian_base',
    values = {        
        { text = "disabled", help = "Spawn no civilians.", key = 1, },
        { text = "enabled - no defences", help = "Spawn a small civilian base with no defences.", key = 2, },
        { text = "enabled - t1 defences", help = "Spawn a small civilian base with some t1 point defences.", key = 3, },
        { text = "enabled - t2 defences", help = "Spawn a small civilian base with some t2 point defences.", key = 4, },
        { text = "enabled - t3 defences", help = "Spawn a small civilian base with t3 sams and t2 point defence.", key = 5, },
        { text = "enabled - arty/t3 defences", help = "Spawn a small civilian base with t3 sams and t2 artys.", key = 6, },
    },
},
{
    default = 1,
    label = "Civilian Base - Shields",
    help = "Spawn a civilian base on the side plateaus.",
    key = 'optional_civilian_shields',
    pref = 'optional_civilian_shields',
    values = {        
        { text = "disabled", help = "Spawn no defencive shields for the civilian outposts.", key = 1, },
        { text = "some shielding", help = "Spawn a small shield at the civilian base.", key = 2, },
        { text = "strong shielding", help = "Spawn a several shields at the civilian base.", key = 3, },
    },
},

{
    ...
    help = "Spawns one additional mex for each player in the starting base.",
    key = 'additionalmex',
    pref = 'additionalmex',
    values = {
