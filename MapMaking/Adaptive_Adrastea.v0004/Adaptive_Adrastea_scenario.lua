...
ScenarioInfo = {
    ...
    map_version = 4,
    AdaptiveMap = true,
    map = '/maps/Adaptive_Adrastea.v0004/Adaptive_Adrastea.scmap',
    save = '/maps/Adaptive_Adrastea.v0004/Adaptive_Adrastea_save.lua',
    script = '/maps/Adaptive_Adrastea.v0004/Adaptive_Adrastea_script.lua',
