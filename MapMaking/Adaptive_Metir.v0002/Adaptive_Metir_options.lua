...

{
    ...
    pref = 'underwatermex',
    values = {
        { text = "enabled - more mex", help = "Spawn 20 additional mexes in the water around the islands.", key = 1, },
        { text = "enabled", help = "Spawn 12 additional mexes in the water around the islands.", key = 2, },
        { text = "enabled - fewer mex", help = "Spawn 6 additional mexes in the water around the islands.", key = 3, },
...

{
    ...
    values = {
        ...
        { text = "some reclaim", help = "Add some destroyers to the beaches of the map.", key = 2, },
        { text = "more reclaim", help = "Add some destroyers and some t3 air units to the map.", key = 3, },
        { text = "much more reclaim", help = "Add some destroyers, some t3 air units and 3 t3 navy factories to the map.", key = 4, },
        { text = "CZAR", help = "Add some destroyers, some t3 air units, 3 t3 navy factories and a CZAR wreck to the map.", key = 5, },
    },
},
