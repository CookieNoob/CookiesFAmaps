...
local Tables = import('/maps/adaptive_corona.v0002/adaptive_corona_tables.lua')
...
local islandmex = ScenarioInfo.Options.islandmex or 3
...
------------------------------------------------------------------------
    ...
    if( optional_reclaim > 1 and optional_reclaim < 6) then
        ScenarioUtils.CreateArmyGroup('ARMY_17', 'Optional_Wreckage_' .. optional_reclaim, true)
    elseif(optional_reclaim == 6 ) then
        ScenarioUtils.CreateArmyGroup('ARMY_17', 'Optional_Wreckage_' .. 4, true)
        ScenarioUtils.CreateArmyGroup('ARMY_17', 'Optional_Wreckage_' .. 5, true)
    end
