...
},
{
	default = 1,
	label = "reclaim",
	help = "add groups of wrecks",
	key = 'optional_reclaim',
	pref = 'optional_reclaim',
	values = {
		{ text = "no reclaim", help = "Do not add additional reclaim.", key = 1, },
		{ text = "some reclaim", help = "Add a group of t1 units to the side areas.", key = 2, },
		{ text = "more reclaim", help = "Add a group of t2 units to the side areas.", key = 3, },
		{ text = "a lot of reclaim", help = "Add a group of t3 units to the side areas.", key = 4, },
		{ text = "Fatboy wreck", help = "Add a Fatboy to the middle.", key = 5, },
        { text = "Fatboy+t3army", help = "Add a Fatboy to the middle.", key = 6, },
	},
},
{
    default = 1,
