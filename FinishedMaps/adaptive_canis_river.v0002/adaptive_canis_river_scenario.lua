...
ScenarioInfo = {
    ...
    AdaptiveMap = true,
    size = {512, 512},
    map = '/maps/adaptive_canis_river.v0002/adaptive_canis_river.scmap',
    save = '/maps/adaptive_canis_river.v0002/adaptive_canis_river_save.lua',
    script = '/maps/adaptive_canis_river.v0002/adaptive_canis_river_script.lua',
