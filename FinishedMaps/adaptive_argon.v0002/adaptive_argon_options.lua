...

{
    ...
    values = {
        ...
        { text = "some reclaim", help = "Add some reclaim to the map.", key = 2, },
        { text = "small groups", help = "Add 2 t2 armies to the middle area of the map.", key = 3, },
        { text = "more reclaim", help = "Add 2 t2 armies and some Harbringer wrecks to the middle area of the map.", key = 4, },
        { text = "czar", help = "Add 2 t2 armies and some Harbringer wrecks to the middle area of the map. Furthermore there will be a Czar wreck in the center of the map.", key = 5, },
    },
},
{
    default = 1,
