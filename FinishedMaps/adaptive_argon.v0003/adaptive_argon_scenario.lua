...
ScenarioInfo = {
    ...
    map_version = 3,
    AdaptiveMap = true,
    map = '/maps/adaptive_argon.v0003/adaptive_argon.scmap',
    save = '/maps/adaptive_argon.v0003/adaptive_argon_save.lua',
    script = '/maps/adaptive_argon.v0003/adaptive_argon_script.lua',
