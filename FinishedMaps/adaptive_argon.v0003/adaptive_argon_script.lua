...
local Tables = import('/maps/adaptive_argon.v0003/adaptive_argon_tables.lua')
...
local middle_mexes = ScenarioInfo.Options.middle_mexes or 3
local side_mexes = ScenarioInfo.Options.side_mexes or 2
...
function OptionalUnits()
    ...
    LOG("ADAPTIVE: optional_civilian_base_middle = ", optional_civilian_base_middle)
    LOG("ADAPTIVE: optional_civilian_base_middle_shields = ", optional_civilian_base_middle_shields)
    LOG("ADAPTIVE: optional_civilian_base_side = ", optional_civilian_base_side)
    LOG("ADAPTIVE: optional_civilian_base_side_shields = ", optional_civilian_base_side_shields)
