...
local Tables = import('/maps/adaptive_ians_cross.v0002/adaptive_ians_cross_tables.lua')
...
------------------------------------------------------------------------
    ...
    if (optional_reclaim > 1 and optional_reclaim < 3) then
        ScenarioUtils.CreateArmyGroup('ARMY_17', 'Optional_Wreckage_' .. optional_reclaim, true)
    end
    if(optional_reclaim > 2 and optional_reclaim < 6) then
        for i = 3, optional_reclaim do
