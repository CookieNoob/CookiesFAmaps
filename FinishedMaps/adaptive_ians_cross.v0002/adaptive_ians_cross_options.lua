...

{
	...
	values = {
		...
		{ text = "disabled - 4v4 mex", help = "Map will not adjust for players and will spawn the mexes of the eight usual players and their expansions. Use the spots 1-8", key = 3, },
...

{
	...
	pref = 'middlemex',
	values = {
		{ text = "enabled - more mex", help = "Spawn 16 additional mexes in the middle.", key = 1, },
		{ text = "enabled", help = "Spawn 12 additional mexes in the middle.", key = 2, },
		{ text = "enabled - fewer mex", help = "Spawn 8 additional mexes in the middle.", key = 3, },
		{ text = "enabled - very few mex", help = "Spawn 4 additional mexes in the middle.", key = 4, },
...

{
	...
	pref = 'sidemex',
	values = {
		{ text = "enabled - more mex", help = "Spawn 12 additional mexes on each side.", key = 1, },
		{ text = "enabled", help = "Spawn 8 additional mexes on each side.", key = 2, },
        { text = "enabled - fewer mex", help = "Spawn 4 additional mexes on each side.", key = 3, },
...

{
	...
	values = {
		...
		{ text = "CZAR wreck", help = "Add a crashlanded CZAR to the middle of the map.", key = 2, },
		{ text = "small Aeon patrol", help = "Add a small Aeon patrol to the middle of the map.", key = 3, },
		{ text = "Aeon patrol", help = "Add a destroyed Aeon patrol to the middle of the map.", key = 4, },
		{ text = "large Aeon patrol", help = "Add a large destroyed Aeon patrol to the middle of the map.", key = 5, },
	},
},
