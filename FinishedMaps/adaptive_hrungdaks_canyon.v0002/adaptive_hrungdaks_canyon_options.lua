...

{
    ...
    values = {
        ...
        { text = "disabled - 3v3 mex", help = "Map will not adjust for players and will spawn the mexes of the three usual players per team and their expansions. Use the spots 1-6", key = 2, },
        { text = "disabled - 4v4 mex", help = "Map will not adjust for players and will spawn the mexes of the four usual players per team and their expansions. Use the spots 1-8", key = 3, },
...

{
    ...
    help = "configure the amount of mexes on the sides of the map (on the small plateaus).",
    key = 'sidemex',
    pref = 'sidemex',
    values = {
        ...
        { text = "enabled - less mex", help = "Spawn 1 additional mexes on each side.", key = 3, },
...

{
    ...
    values = {
        ...
        { text = "some reclaim", help = "Add a t2 army to the middle of the map.", key = 2, },
        { text = "more reclaim", help = "Add a t3 army to the middle of the map.", key = 3, },
        { text = "galactic colossus", help = "Add a galactic colossus to the center of the map.", key = 4, },
    },
},

{
	...
	values = {
        ...
        { text = "t3 defences", help = "Adds a civilian base with t3 defencive structures and t2 arty to the middle of the map. These civilians are tough to crack!", key = 8},
        { text = "t3 defences+shields", help = "Adds a shielded civilian base with t3 defencive structures and t2 arty to the middle of the map. These civilians are tough to crack!", key = 9},
	},
},
...

{
    ...
    help = "makes a few mexes on the passage at the side behave like crazyrush mexes.",
...

{
    default = 1,
    label = "jamming",
    help = "adds seraphim jamming crystals to the map to project some false radar signals.",
    key = 'jamming',
    pref = 'jamming',
    values = {
        { text = "disabled", help = "Do not add jamming.", key = 1, },
        { text = "enabled", help = "Add some crystals with jamming to the map.", key = 2, },
        { text = "enabled - strong jam", help = "Add more crystals with jamming to the map.", key = 3, },
    },
},
...

{
    default = 1,
    label = "mirror spots",
    help = "Only spawn ressources when mirror spots are taken. Mirror spots are opposing spots that are listed together (i.e. 3+4 or 9+10). If the function is enabled and one of these spots is not taken, the mexes for both spots will not spawn.",
    key = 'mirrormex',
    pref = 'mirrormex',
    values = {
