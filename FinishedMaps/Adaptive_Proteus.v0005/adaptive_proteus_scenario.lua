...
ScenarioInfo = {
    ...
    AdaptiveMap = true,
    size = {512, 512},
    map = '/maps/Adaptive_Proteus.v0005/adaptive_proteus.scmap',
    save = '/maps/Adaptive_Proteus.v0005/adaptive_proteus_save.lua',
    script = '/maps/Adaptive_Proteus.v0005/adaptive_proteus_script.lua',
