...

{
    ...
    values = {
        ...
        { text = "disabled - 4v4 mex", help = "Map will not adjust for players and will spawn the mexes for eight players and their expansions. Use the spots 1-8", key = 2, },
...

{
    ...
    pref = 'middlemex',
    values = {
        { text = "enabled - more mex", help = "Spawn 8 additional mexes in the middle.", key = 1, },
        { text = "enabled", help = "Spawn 6 additional mexes in the middle.", key = 2, },
...

{
    ...
    help = "configure the amount of additional mexes on the islands of the map. (some positions spawn mexes on the islands as well)",
    key = 'islandmex',
    pref = 'islandmex',
    values = {
...

{
    ...
    values = {        
        { text = "disabled", help = "Spawn no civilians in the center.", key = 1, },
        { text = "t1 defences", help = "Spawn a small civilian base with some t1 point defences in the center.", key = 2, },
        { text = "t2 defences", help = "Spawn a small civilian base with some t2 point defences in the center.", key = 3, },        
        { text = "t3 defences", help = "Spawn a small civilian base with some t3 sams in the center.", key = 4, },
        { text = "t1 defences+shields", help = "Spawn a small shielded civilian base with some t1 point defences in the center.", key = 5, },
        { text = "t2 defences+shields", help = "Spawn a small shielded civilian base with some t2 point defences in the center.", key = 6, },        
        { text = "t3 defences+shields", help = "Spawn a small shielded civilian base with some t3 sams in the center.", key = 7, },
    },
},
...

{
    default = 3,
    label = "lightning",
    help = "Sets the lightning effects of the crystals",
    key = 'Lightning',
    pref = 'Lightning',
    values = {
        { text = "disabled", help = "No lightning", key = 1, },
        { text = "enabled - less", help = "Some lightning, but not so much.", key = 2, },
        { text = "enabled", help = "Normal lightning settings.", key = 3, },
        { text = "enabled - more", help = "Lightning storm.", key = 4, },
    },
},
