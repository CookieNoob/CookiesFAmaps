...
ScenarioInfo = {
    ...
    starts = true,
    size = {512, 512},
    map = '/maps/Adaptive_Twilight_Hill.v0004/Adaptive_Twilight_Hill.scmap',
    save = '/maps/Adaptive_Twilight_Hill.v0004/Adaptive_Twilight_Hill_save.lua',
    script = '/maps/Adaptive_Twilight_Hill.v0004/Adaptive_Twilight_Hill_script.lua',
    norushradius = 60,
    Configurations = {
        ['standard'] = {
            teams = {
