version = 3
ScenarioInfo = {
    name = 'Adaptive Syrtis Major',
    description = 'The Proxima-Syrtis system was a small Aeon colony until the opening of a quantum rift shifted a hyperspace line into the system. Suddently, the base gained strategic importance, being on one of the main supply lines of the Cybrans. Since then, a never ending battle raged on the main planet of Proxima-Syrtis. Map adjusted for dynamic ressources. Script and edit by CookieNoob, coding help from KeyBlue. Civilians by Super.',
    type = 'skirmish',
    starts = true,
    size = {512, 512},
    map = '/maps/adaptive_syrtis_major.v0001/adaptive_syrtis_major.scmap',
    save = '/maps/adaptive_syrtis_major.v0001/adaptive_syrtis_major_save.lua',
    script = '/maps/adaptive_syrtis_major.v0001/adaptive_syrtis_major_script.lua',
    preview = '',
    AdaptiveMap = true,
    map_version = 1, 
    norushradius = 125.000000,
    norushoffsetX_ARMY_1 = 0.000000,
    norushoffsetY_ARMY_1 = 0.000000,
    norushoffsetX_ARMY_2 = 0.000000,
    norushoffsetY_ARMY_2 = 0.000000,
    norushoffsetX_ARMY_3 = 5.000000,
