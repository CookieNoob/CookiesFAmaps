version = 3
ScenarioInfo = {
    name = 'Adaptive Point of Reason',
    description = 'The Infinite War decimated many systems and turned this planet into an uninhabitable wasteland. The thermonuclear bombardment made it completely empty and the atmosphere started evaporating. In the effort to save cybran refugees Doctor Brackman tested his terraformer. Within a few weeks many unique species came to existance here. This ironically brought the war back to this planet and the cybrans were forced to leave it. Map adjusted for dynamic spawns, graphical enhancements and customization options by CookieNoob. Underwater hightmap, Textures, Decals and general visual improvements by Tokyto. Original Map by Plasma_Wolf. This is an alternative visual version of Point of Reach',
    type = 'skirmish',
    starts = true,
    preview = '',
    size = {1024, 1024},
    map = '/maps/adaptive_point_of_reason.v0002/adaptive_point_of_reason.scmap',
    map_version = 2,
    AdaptiveMap = true,
    save = '/maps/adaptive_point_of_reason.v0002/adaptive_point_of_reason_save.lua',
    script = '/maps/adaptive_point_of_reason.v0002/adaptive_point_of_reason_script.lua',
