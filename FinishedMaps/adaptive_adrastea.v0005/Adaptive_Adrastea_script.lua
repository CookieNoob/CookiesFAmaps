...
local optional_reclaim = ScenarioInfo.Options.optional_reclaim or 3
...
------------------------------------------------------------------------
    ...
    if optional_reclaim > 1 then
        for reclaim = 2, optional_reclaim do
            ScenarioUtils.CreateArmyGroup('ARMY_17', 'Wrecks'..reclaim, true)
        end
    end
