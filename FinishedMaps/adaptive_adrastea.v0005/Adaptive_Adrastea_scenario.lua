...
ScenarioInfo = {
    ...
    map_version = 5,
    AdaptiveMap = true,
    map = '/maps/adaptive_adrastea.v0005/Adaptive_Adrastea.scmap',
    save = '/maps/adaptive_adrastea.v0005/Adaptive_Adrastea_save.lua',
    script = '/maps/adaptive_adrastea.v0005/Adaptive_Adrastea_script.lua',
