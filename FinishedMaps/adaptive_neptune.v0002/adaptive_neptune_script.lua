...
local Tables = import('/maps/adaptive_neptune.v0002/adaptive_neptune_tables.lua')
...
-- get scenario info about how the map should look like, if no option is changed, change it to the default
    ...
    LOG("ULTIMATE", automex, hydroplus, optional_reclaim_middle, optional_reclaim_side, middlemex, sidemex, underwatermex, optional_reclaim, mirrormex, optional_civilian_base)
-- get map markers
...
-- corresponds to player one, the second to player 2 and so on... load it from the _tables.lua file
    ...
    local spwnAdditionalunderwatermex = Tables.underwatermex;
...
-- Expansion script from Primus_Alpha by Super, Ithilis_Quo and Speed2
