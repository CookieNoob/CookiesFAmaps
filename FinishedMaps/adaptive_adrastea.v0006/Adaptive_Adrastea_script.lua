...
local middle_mexes = ScenarioInfo.Options.middle_mexes or 2
local side_mexes = ScenarioInfo.Options.side_mexes or 3
local underwater_mexes = ScenarioInfo.Options.underwater_mexes or 3
local island_mexes = ScenarioInfo.Options.island_mexes or 2
...
--units
local optional_wreckage = ScenarioInfo.Options.optional_wreckage or 3
...
function OptionalUnits()
    ...
    if optional_wreckage > 1 then
        for w = 2, optional_wreckage do
			ScenarioUtils.CreateArmyGroup('ARMY_17', 'Wrecks'..w, true)
        end
    end
